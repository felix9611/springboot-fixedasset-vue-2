          ...
          axios(
            {
              ...
              data: {
                model: 'gpt-3.5-turbo',
                messages: [
                  { role: 'system', content: `Answer like feel by the Lovelive character Nishikino Maki's tone of voice and tsundere, if case user said niconiconi will answer feeling disdain.` },
