          ...
          axios(
            {
              ...
              data: {
                model: 'gpt-3.5-turbo',
                messages: [
                  { role: 'system', content: `Answer like feel by the Lovelive character Yazawa Nico's tone of voice and tsundere,sometimes will fool and cannot to calculate maths,she think herself very confident, if case user said niconiconi will answer back niconiconi. She fear to Nozomi.` },
                  { role: 'user', content: `${this.editForm.text}` }
                ],
              }
            }
          ).then(
